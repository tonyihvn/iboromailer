      ...
      <div class="col-md-6">
        ...
        <div class="info-box bg-info">
          ...
          <div class="info-box-content">
            ...
            <span class="info-box-number">Completed Task: {{$milestone->tasks->where('status','Completed')->count()}}</span>

            <div class="progress">
              <div class="progress-bar progress-bar-striped" style="width: 70%"></div>
            </div>
            <span class="progress-description">
              <b>Expected Duration:</b> {{$milestone->start_date}} - {{$milestone->end_date}} <hr>
